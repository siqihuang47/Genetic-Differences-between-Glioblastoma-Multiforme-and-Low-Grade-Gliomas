...
# Call the r script of survival plots to draw survival plots
def draw_survival_plot():
    subprocess.call("/src/visualization/survival_plots_r.R", shell=True)
...
def draw_focal_proportion_plots():
